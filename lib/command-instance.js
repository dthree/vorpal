...
function CommandInstance(options) {
  ...
  this.prompt = function (a, b, c) {
    return self.session.prompt.call(self.session, a, b, c);
  };

  this.delimiter = function (a, b, c) {
    return self.session.delimiter.call(self.session, a, b, c);
  };

  this.help = function (a, b, c) {
    return self.session.help.call(self.session, a, b, c);
  };

  this.match = function (a, b, c) {
    return self.session.match.call(self.session, a, b, c);
  };
