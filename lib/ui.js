...
var ui = {
  ...
  _init: function () {
    ...
    // Loop using lodash to create closure while looping.
    // Can be replaced with "for of" when Babel is implemented (ES6 block scoping).
    _.each(prompts, function (promptType) {
  ...
  _keypressHandler: function (e, prompt) {
    ...
    // TODO: Remove above and replace with below when Babel is implemented:
    // var line = prompt.getType() !== 'password' ?
    //   prompt.rl.line :
